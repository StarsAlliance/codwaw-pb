...
1. Introduction
 ...
 Linux server version 1.7. Installation from scratch and upgrading an existing
...
5. Support Channels
 ...
 are eager to help with politely-asked questions. List archives and access to
 the list can obtained at:
